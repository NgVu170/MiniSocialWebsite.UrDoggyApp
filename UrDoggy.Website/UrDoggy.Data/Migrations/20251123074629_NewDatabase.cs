...
{
    /// <inheritdoc />
<<<<<<<< HEAD:UrDoggy.Website/UrDoggy.Data/Migrations/20250927130316_AddGroupAndRelations.cs
    public partial class AddGroupAndRelations : Migration
========
    public partial class NewDatabase : Migration
>>>>>>>> TaggedUser:UrDoggy.Website/UrDoggy.Data/Migrations/20251123074629_NewDatabase.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivtyScore = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostTaggedUsers", x => new { x.PostId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupDetails_GroupId_UserId",
                table: "GroupDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Media_PostId_CreatedAt",
                table: "Media",
                columns: new[] { "PostId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_PostId_CreatedAt",
                table: "Reports",
                columns: new[] { "PostId", "CreatedAt" });
